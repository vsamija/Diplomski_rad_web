...
addLabel <- function(data) {
  data$label <- paste0(
    ...
    <tr><td>Potvrdjeni:</td><td align="right">', data$confirmed, '</td></tr>
    <tr><td>Preminuli:</td><td align="right">', data$deceased, '</td></tr>
    <tr><td>Oporavljeni:</td><td align="right">', data$recovered, '</td></tr>
    <tr><td>Aktivni:</td><td align="right">', data$active, '</td></tr>
    </table>'
  )
